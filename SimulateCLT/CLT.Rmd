...
v_sd <- sd(v)
v_var <- var(v,v) ## would be same as v_sd^2
  
ggplot() + aes(v)+ geom_histogram(binwidth=0.05, colour="black", fill="white") + geom_vline(aes(xintercept=v_mean), color="red", linetype="dashed", size=1)
